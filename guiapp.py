...
def user_login_event(event):
    ...
    print("Tkinter entry text {}".format(e1.get()))
    print("Tkinter pass text {}".format(e2.get()))
...
e2 = tk.Entry(window, textvariable=password, show='*') ##passEntry = Entry(app, textvariable=password, show='*')
