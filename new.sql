...
CREATE TABLE IF NOT EXISTS `qpaper` (
  ...
  `opt3` text NOT NULL,
  `opt4` text NOT NULL,
  `ansrep` text NOT NULL DEFAULT '' COMMENT 'ans selected',
...
CREATE TABLE `host_summary` (
	...
	`statement_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`statement_avg_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`table_scans` DECIMAL(65,0) NULL,
	`file_ios` DECIMAL(64,0) NULL,
	`file_io_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`current_connections` DECIMAL(41,0) NULL,
	`total_connections` DECIMAL(41,0) NULL,
	`unique_users` BIGINT(21) NOT NULL,
	`current_memory` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`total_memory_allocated` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_file_io` (
	...
	`io_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_file_io_type` (
	...
	`total_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_stages` (
	...
	`total_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`avg_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_statement_latency` (
	...
	`total_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`lock_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
...
CREATE TABLE `innodb_buffer_stats_by_schema` (
	`object_schema` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`allocated` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`data` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
...
CREATE TABLE `innodb_buffer_stats_by_table` (
	`object_schema` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`object_name` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`allocated` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`data` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`pages` BIGINT(21) NOT NULL,
	`pages_hashed` BIGINT(21) NOT NULL,
...
CREATE TABLE `io_by_thread_by_latency` (
	...
	`total` DECIMAL(42,0) NULL,
	`total_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`min_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`avg_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`thread_id` BIGINT(20) UNSIGNED NOT NULL COMMENT 'Thread associated with the event. Together with EVENT_NAME uniquely identifies the row.',
...
CREATE TABLE `io_global_by_file_by_bytes` (
	...
	`count_read` BIGINT(20) UNSIGNED NOT NULL COMMENT 'Number of all read operations, including FGETS, FGETC, FREAD, and READ.',
	`total_read` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`avg_read` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`count_write` BIGINT(20) UNSIGNED NOT NULL COMMENT 'Number of all write operations, including FPUTS, FPUTC, FPRINTF, VFPRINTF, FWRITE, and PWRITE.',
	`total_written` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`avg_write` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`total` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
...
CREATE TABLE `io_global_by_file_by_latency` (
	...
	`total_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`count_read` BIGINT(20) UNSIGNED NOT NULL COMMENT 'Number of all read operations, including FGETS, FGETC, FREAD, and READ.',
	`read_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`count_write` BIGINT(20) UNSIGNED NOT NULL COMMENT 'Number of all write operations, including FPUTS, FPUTC, FPRINTF, VFPRINTF, FWRITE, and PWRITE.',
	`write_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`count_misc` BIGINT(20) UNSIGNED NOT NULL COMMENT 'Number of all miscellaneous operations not counted above, including CREATE, DELETE, OPEN, CLOSE, STREAM_OPEN, STREAM_CLOSE, SEEK, TELL, FLUSH, STAT, FSTAT, CHSIZE, RENAME, and SYNC.',
	`misc_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `io_global_by_wait_by_bytes` (
	...
	`count_write` BIGINT(20) UNSIGNED NOT NULL COMMENT 'Number of all write operations, including FPUTS, FPUTC, FPRINTF, VFPRINTF, FWRITE, and PWRITE.',
	`total_written` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`avg_written` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`total_requested` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `memory_by_host_by_current_bytes` (
	...
	`current_allocated` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`current_avg_alloc` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`current_max_alloc` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`total_allocated` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `memory_global_by_current_bytes` (
	...
	`current_alloc` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`current_avg_alloc` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`high_count` BIGINT(20) NOT NULL COMMENT 'Highest number of allocated blocks (highest value of CURRENT_COUNT_USED).',
	`high_alloc` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`high_avg_alloc` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `processlist` (
	...
	`trx_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
...
CREATE TABLE `schema_table_lock_waits` (
	...
	`waiting_account` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	...
	`blocking_account` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
...
CREATE TABLE `schema_table_statistics` (
	...
	`fetch_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`rows_inserted` BIGINT(20) UNSIGNED NOT NULL COMMENT 'Number of all insert operations.',
	`insert_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`rows_updated` BIGINT(20) UNSIGNED NOT NULL COMMENT 'Number of all update operations.',
	`update_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	...
	`io_read` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`io_read_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`io_write_requests` DECIMAL(42,0) NULL,
	`io_write` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`io_write_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `schema_table_statistics_with_buffer` (
	...
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_allocated` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_data` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_free` TEXT(65535) NULL COLLATE 'utf8mb3_general_ci',
